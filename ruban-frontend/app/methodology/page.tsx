    ...
    <div className="min-h-screen py-24 px-4">
      <div className="max-w-5xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-muted max-w-3xl mx-auto">
          Structured. Explainable. Confidence-based. RUBAN is built to show how a read is formed, not just what side it lands on.
        </p>
      </div>
      ...
      <div className="max-w-3xl mx-auto card bg-elevated text-center">
        <p className="text-lg text-muted leading-relaxed">
          <strong className="text-white">We don't promise wins.</strong> We structure decisions. Every fight is analyzed through multiple lenses. Every pick includes confidence, volatility, and reasoning. <strong className="text-white">No locks. No guarantees.</strong> Just sharper reads and clearer context.
        </p>
      </div>
    </div>
  );
